...
export class World {
  constructor(scene) {
    ...
    this.mats = {
      ...
      granite: (() => { const t = graniteTexture(); return new THREE.MeshStandardMaterial({ map: t, bumpMap: t, bumpScale: 1.4, roughness: 0.9 }); })(),
      graniteBig: (() => { const t = graniteTexture(8, 6); return new THREE.MeshStandardMaterial({ map: t, bumpMap: t, bumpScale: 1.6, roughness: 0.9 }); })(),
      roof: (() => { const t = roofTexture(); return new THREE.MeshStandardMaterial({ map: t, bumpMap: t, bumpScale: 1.1, roughness: 0.9 }); })(),
      ...
      stoneFloor: (() => { const t = stoneFloorTexture(); return new THREE.MeshStandardMaterial({ map: t, bumpMap: t, bumpScale: 1.2, roughness: 0.9 }); })(),
